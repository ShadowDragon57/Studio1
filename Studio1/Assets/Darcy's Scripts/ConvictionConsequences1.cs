...
public class ConvictionConsequences1 : MonoBehaviour
{
    [SerializeField]
    private Text health;

    [SerializeField]
    private float convictionCount, healthAfterChange, timeCount;
    ...
    {
        convictionCount = GetComponent<ConvictionCalculator1>().convictionCount; //getting the value of conviction from the calculator
