...
{
    [SerializeField]
    private Transform player, boosterTransform, earthenTransform, shieldTransform, pulseTransform, voidTransform, aimTransform;
    [SerializeField]
    private Transform[] bladeTransforms;
    [SerializeField]
    private GameObject strike, earthen, sun, wall, beam, booster, lance, shield, pulse, voidAbility, aimObject, qAbilityActive, eAbilityActive, abilityUsed;
    [SerializeField]
