...
public class TutorialCards : MonoBehaviour
{
    ...
    void SetCardDisplay(int cardID)
    {
        switch (cardID)
        {
            ...
            case 2: //Interactables
                cardDisplay.GetComponent<RawImage>().texture = tutorialCardsInteractables[cardPickup.GetComponent<cardVariables>().currentDisplay];
                variableList.GetComponent<tutorialPageVariables>().interactables1Bool = true;
                break;
            case 3: //Rocks
                cardDisplay.GetComponent<RawImage>().texture = tutorialCardsRockTutorial[cardPickup.GetComponent<cardVariables>().currentDisplay];
                variableList.GetComponent<tutorialPageVariables>().rockTutorial1Bool = true;
                break;
            case 4: //Abilities
                cardDisplay.GetComponent<RawImage>().texture = tutorialCardsAbilities[cardPickup.GetComponent<cardVariables>().currentDisplay];
            ...
            case 5: //Pause
                ...
                break;
            case 6: //Reset
                cardDisplay.GetComponent<RawImage>().texture = tutorialCardsReset[cardPickup.GetComponent<cardVariables>().currentDisplay];
    ...
    {
        if (cardPickup.GetComponent<cardVariables>().seriesNum > cardPickup.GetComponent<cardVariables>().currentDisplay)
        {
        ...
        if (cardPickup.GetComponent<cardVariables>().currentDisplay > 0)
        {
    ...
    {
        cardPickup.GetComponent<cardVariables>().currentDisplay++;
        nextCardBool = false;
